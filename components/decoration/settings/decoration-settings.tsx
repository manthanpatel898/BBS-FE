...
const tabs: Array<{id:DecorationSettingsTab;label:string}>=[{id:'profile',label:'Company Profile'},{id:'events',label:'Event Types'},{id:'venues',label:'Banquets, Outdoor Venues & Halls'},{id:'decoration',label:'Decoration'}];
