...
test('allows an advance before the final package price is set', () => {
  assert.deepEqual(
    validateDecorationConfirmationForm(
      { ...base, advanceAmount: '2500', paymentDate: '2026-07-21', paymentMode: 'UPI' },
      0,
      0,
      false,
    ),
