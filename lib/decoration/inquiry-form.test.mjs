...
const valid = {
  ...
  timeSlot: 'EVENING', startDate: '2026-07-18', endDate: '2026-07-18', packageRate: '100000',
};
...
test('builds normalized create payload', () => {
  assert.deepEqual(buildDecorationBookingPatch(null, valid), {
    ...
    address: null, timeSlot: 'EVENING', startDate: '2026-07-18', endDate: '2026-07-18', packageRate: 100000, notes: null,
  });
});
...
test('rejects a previous date only while creating a new inquiry', () => {
  assert.match(
    validateDecorationInquiry(
      { ...valid, startDate: '2026-07-17', endDate: '2026-07-17' },
