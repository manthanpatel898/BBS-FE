...
test('binary request invokes an injected browser fetch as a standalone function', async () => {
  ...
  await requestDecorationCustomerPdf({
    apiUrl: 'https://api.test', accessToken: 'secret', bookingId: 'booking-1',
