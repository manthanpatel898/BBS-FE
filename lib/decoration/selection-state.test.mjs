...
test('normalizes payload without empty optional descriptions', () => {
  ...
  assert.deepEqual(buildDecorationSelectionPayload(state), { items: [{ itemId: 'red', quantity: 1, imageId: 'red-image' }], customItems: [{ name: 'Arch', quantity: 1, imageKey: 'k', imageUrl: 'u' }] });
});
