...
export type DecorationReportFilters={month?:string;date?:string;from?:string;to?:string;status?:string;eventTypeId?:string;venueId?:string;hallId?:string;creatorId?:string;paymentState?:string;search?:string;page?:string;limit?:string};
